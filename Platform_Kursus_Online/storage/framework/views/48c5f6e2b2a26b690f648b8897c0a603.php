    ...
    <div class="certificate-wrapper">
        <div class="certificate-content">
            ...
            <div class="cert-description">
                dengan hasil memuaskan dan dinyatakan lulus pada tanggal <?php echo e($date); ?>.
            </div>
            ...
            <div class="cert-footer">
                ...
                <div class="right">
                    <div class="signature">Farhan Defra</div>
                    <div style="font-size: 12px; color: #4b5563;">Direktur Defalima Course</div>
                    <div style="font-size: 12px; color: #9ca3af; margin-top: 4px;"><?php echo e($date); ?></div>
                </div>
            </div>

            <!-- Nomor Sertifikat -->
            <div class="cert-number">Nomor Sertifikat: <?php echo e($certificate->certificate_number); ?></div>
        </div>
    </div>
</body>
</html><?php /**PATH D:\Platform Kursus Online\Platform_Kursus_Online\resources\views/certificates/pdf.blade.php ENDPATH**/ ?>